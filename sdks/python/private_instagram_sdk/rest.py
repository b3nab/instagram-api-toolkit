...
from private_instagram_sdk.exceptions import ApiException, ApiValueError
...
class RESTClientObject(object):
    ...
    def request(self, method, url, query_params=None, headers=None,
        ...
        try:
            data = '&'.join([ '='.join(str(el) for el in par) for par in post_params])

            # print('####')
            # print('Build the session request with:')
            # print('method: ', method)
            # print('url: ', url)
